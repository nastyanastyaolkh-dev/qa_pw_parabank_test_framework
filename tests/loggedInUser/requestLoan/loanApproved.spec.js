...
test('Loan approved', async ({ existingUser, requestLoanPage, accountOverviewPage }) => {
  ...
  await accountOverviewPage.assertAccountBalance(newAccountNumber, `$${loanData.loanAmount}`);
})
